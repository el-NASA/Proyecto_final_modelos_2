...
class Mundo {
	constructor(){
		...
		this.espacio = 32;
		this.img = document.createElement("img");
		this.img.src = "static/mundo.png";
		this.imgNube = document.createElement("img");
		this.imgNube.src = "static/nube.png";
		this.nx = 350;
		this.ny = 50;
		this.nd = 250;
	}
...
class Corredor extends Objeto {
	constructor(){
		...
		this.img.src = "static/runner.png";
...
class Tiempo {
	constructor(){
		...
		this.sonido.src = "static/aviso.mp3";
	}
	dibujar(){
		ctx.font = "25px Arial";
...
function findeJuego(){
	...
	document.getElementById("imgbtn").src = "static/otravez.png";
	mundo = new Mundo();
	runner = new Corredor();
	velocidad = 50;
	velocidadSalto = 25;
