...
var Juego = {    
    ...
    preload: function(){
        ...
        juego.load.image('fondo', 'static/saltarin/img/img_j1/giphy.jpg');
        juego.load.image('personaje', 'static/saltarin/img/img_j1/personaje1.png');
        juego.load.image('obstaculo', 'static/saltarin/img/img_j1/obstaculo.png');
