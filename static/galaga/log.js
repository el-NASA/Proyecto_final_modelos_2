...
this.controles.src = "static/galaga/controles.png";

this.fondo2 = this.document.createElement('img');
this.fondo2.src = "static/galaga/fondo2.png";
...
function masEnemigos(){
    ...
    for(var i=0; i<13; i++){
        ...
        nave.src = "static/galaga/nave.png";
        objetos.push({
                x:20+ (80*i),
                y:60 + (80*j),
                width: 60, height: 60,
            ...
            for(var i=0; i< objetos.length; i++){
                ...
                if(objetos[i].y+50 > disparos[j].y &&
                    ...
                    if(objetos[i].vida< (vidaE/2+1)){
                        objetos[i].imagen.src= "static/galaga/naveD.png";
                    }
...
window.onload = function() {
    ...
    this.imP.src = "static/galaga/pr.png";
    ...
    this.fondo.src = "static/galaga/fondo.jpg";

    this.py = this.document.createElement('img');
    this.py.src = "static/galaga/proyectil.png";
