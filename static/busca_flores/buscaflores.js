...
function bandera(fila,colu){
    ...
    if(btn.prop('firstChild')==null){
         btn.append('<img src="static/busca_flores/Imagenes/iconoBandera.png" width="23px" height="23px">' );
    }
    else{
    ...
    for(i=0;i<10;i++){
        for(j=0;j<10;j++){
            if(tablero[i][j]==9){
                ...
                btn.append('<img src="static/busca_flores/Imagenes/IconoTitulo.png" width="23px" height="23px">')
            }
        }
    }
}
